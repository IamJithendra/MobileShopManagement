...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(12, 7, 18));
        ...
        jLabel4.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/ic_user.png"))); // NOI18N

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/ic_password.png"))); // NOI18N
    ...
    private void loginActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_loginActionPerformed
        try {
            ...
            if (user.equals("")) {
                ...
                /*
                if username entered is "mobilehub" and password entered
                is "mobilehub!@#$" then You will See a Message 
                that you are logged in successfully
                */
            if (user.equals("mobilehub")&&pwd.equals("mobilehub!@#$")) {
                JOptionPane.showMessageDialog(rootPane, "You have Successfully Logged in");
                /*
                If you entered anything else It will show
                " Login Failed Please Retry "
                */
            } else {
                JOptionPane.showMessageDialog(rootPane, "Login Failed please Retry");
                username.setText("");
                password.setText("");
            }
            }
